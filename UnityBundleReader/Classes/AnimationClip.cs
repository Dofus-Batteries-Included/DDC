...
public class HumanGoal
{
    ...
    public HumanGoal(ObjectReader reader)
    {
        ...
        {
            MHintT = version[0] > 5 || version[0] == 5 && version[1] >= 4 ? reader.ReadVector3() : reader.ReadVector4(); //5.4 and up
...
public class HumanPose
{
    ...
    public HumanPose(ObjectReader reader)
    {
        ...
        if (version[0] > 5 || version[0] == 5 && version[1] >= 2) //5.2 and up
        {
            ...
            {
                MTDoFArray[i] = version[0] > 5 || version[0] == 5 && version[1] >= 4 ? reader.ReadVector3() : reader.ReadVector4(); //5.4 and up
            }
        }
    }
}
...
public class ClipMuscleConstant
{
    ...
    public ClipMuscleConstant(ObjectReader reader)
    {
        ...
        MAverageSpeed = version[0] > 5 || version[0] == 5 && version[1] >= 4 ? reader.ReadVector3() : reader.ReadVector4(); //5.4 and up
